<?php
/**
 * EdumapVisibilityFrameSettingFixture
 *
...
/**
 * Summary for EdumapVisibilityFrameSettingFixture
 */
class EdumapVisibilityFrameSettingFixture extends CakeTestFixture {
 ...
 */
	public $fields = array(
		...
		'handle' => array('type' => 'integer', 'null' => false, 'default' => null, 'length' => 4, 'key' => 'primary', 'comment' => 'display handle, 1: display, 0: no display or 2:display only school officials in edumap on | ハンドルの表示の有無  0:表示しない、1:表示する、2:edumap上で学校関係のみ表示する |  | '),
		...
		'indexes' => array(
			'PRIMARY' => array('column' => array('id', 'handle'), 'unique' => 1),
