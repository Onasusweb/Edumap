...
/**
 * Expect Edumap->saveEdumapVisibilitySetting()
 * to validate frames.id and throw exception on error
 *
 * @return void
 */
	public function testSaveEdumapVisibilitySettingExceptionError() {
