...
<?php echo $this->element('Edumap/view_field', ['field' => 'name', 'label' => __d('edumap', 'School name')]); ?>
...
<?php if ($edumapStudents && isset($edumapVisibilitySetting['studentNumber'])) : ?>
	<?php if ($edumapVisibilitySetting['studentNumber'] === '1' || $contentEditable) : ?>
...
<?php if (isset($edumapSocialMedium[EdumapSocialMedium::SOCIAL_TYPE_TWITTER]) && isset($edumapVisibilitySetting['socialMedia'])) : ?>
	<?php if ($edumapVisibilitySetting['socialMedia'] === '1' || $contentEditable) : ?>
		<div class="row form-group">
			...
			<div class="col-xs-12 col-sm-8">
				<?php echo h($edumapSocialMedium[EdumapSocialMedium::SOCIAL_TYPE_TWITTER]); ?>
			</div>
		</div>
	<?php endif; ?>
<?php endif; ?>
...
<?php if (isset($edumap['description']) && $edumap['description'] != '' && isset($edumapVisibilitySetting['description'])) : ?>
	<?php if ($edumapVisibilitySetting['description'] === '1' || $contentEditable) : ?>
		<div class="row form-group">
			<div class="col-xs-12">
