...
<p class="text-center">
	...
	<?php if (isset($edumap['Edumap']) && $contentPublishable &&
				$edumap['Edumap']['status'] === NetCommonsBlockComponent::STATUS_APPROVED) : ?>
		<button type="button" class="btn btn-danger" ng-disabled="sending"
				ng-hide="edumap.Edumap.status !== '<?php echo (NetCommonsBlockComponent::STATUS_APPROVED); ?>'"
