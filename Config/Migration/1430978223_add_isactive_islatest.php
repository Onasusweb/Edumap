		...
		'up' => array(
			...
			'create_field' => array(
				...
				'edumap_visibility_settings' => array(
					'edumap_key' => array('type' => 'string', 'null' => false, 'default' => '1', 'collate' => 'utf8_general_ci', 'comment' => 'edumap key | edumapデータ連携Key | edumap.key | ', 'charset' => 'utf8', 'after' => 'id'),
					'file' => array('type' => 'integer', 'null' => false, 'default' => '1', 'length' => 4, 'comment' => 'display avatar\'s files.id, 1: display, 0: no display or 2:display only school officials in edumap on | 学校名の表示の有無  0:表示しない、1:表示する、2:edumap上で学校関係のみ表示する |  | ', 'after' => 'edumap_key'),
				),
			),
			'alter_field' => array(
				'edumap' => array(
			...
			'drop_field' => array(
				'edumap_students' => array('edumap_key'),
				'edumap_visibility_settings' => array('frame_key'),
			),
			'drop_table' => array(
				'edumap_social_medium'
			),
		),
		'down' => array(
			'drop_table' => array(),
			'drop_field' => array(
				...
				'edumap_visibility_settings' => array('edumap_key', 'file'),
			),
			'alter_field' => array(
				'edumap' => array(
					...
					'foundation_date' => array('type' => 'date', 'null' => true, 'default' => null, 'comment' => 'founded school date | 開校日 |  | '),
					'closed_date' => array('type' => 'date', 'null' => true, 'default' => null, 'comment' => 'closed school date | 閉校日 |  | '),
				...
				'edumap_students' => array(
					'gendar' => array('type' => 'boolean', 'null' => false, 'default' => null, 'comment' => 'gendar, 0: man type, 1: woman type | 性別タイプ 0：男子、1:女子 |  | '),
